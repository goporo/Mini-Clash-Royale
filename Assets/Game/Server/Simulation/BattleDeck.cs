...
{
  /// <summary>
  /// Pure server-side deck/hand manager. Uses CardId enum — no Unity types.
  /// </summary>
  public class BattleDeck
  {
    ...
    /// <summary>
    /// Finds the first slot containing <paramref name="cardId"/>, re-enqueues it,
    /// draws the next card into that slot, and returns the drawn card ID.
    /// </summary>
